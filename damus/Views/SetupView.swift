            ...
            ZStack {
                ...
                VStack(alignment: .center) {
                    ...
                    Image("logo-nobg")
                        ...
                        .padding([.top], 20.0)
                    Text("SixT9", comment: "Name of the app, shown on the first screen when user is not logged in.")
                        .font(Font.custom("Nunito", size: 50.0))
                        .kerning(-2)
                        .foregroundColor(.white)
                    Text("An experimental Nostr client for testing NIP-69.", comment: "")
                        .font(Font.custom("Nunito", size: 20.0))
                        .kerning(-2)
                        .foregroundColor(.white)
                    CarouselView()
