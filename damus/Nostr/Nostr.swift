...
struct Profile: Codable {
    ...
    var nip69: String? {
        get { return str("nip69"); }
        set(s) { set_str("nip69", s) }
    }
...
func make_test_profile() -> Profile {
    return Profile(name: "jb55", display_name: "Will", about: "Its a me", picture: "https://cdn.jb55.com/img/red-me.jpg", banner: "https://pbs.twimg.com/profile_banners/9918032/1531711830/600x200",  website: "jb55.com", lud06: "jb55@jb55.com", lud16: nil, nip05: "jb55@jb55.com", nip69: "larry.btc")
}
